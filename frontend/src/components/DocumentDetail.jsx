  ...
  const handleRollback = async (versionId, versionNumber) => {
    ...
    try {
      ...
      Swal.fire({
        icon: "success",
        title: "Berhasil!",
        text: `Dokumen dipulihkan ke Versi ${versionNumber}.`,
        timer: 2000,
        showConfirmButton: false,
      });
                ...
                <div class="flex items-center gap-2 mb-6 bg-gray-900/80 backdrop-blur-md px-3 py-2 rounded-xl border border-gray-700 shadow-2xl sticky top-4 z-10 transition-all">
                  ...
                  <div class="flex items-center gap-1">
                    ...
                    <div class="flex items-center px-2 text-sm text-gray-400 select-none">
                      <span class="font-bold text-white min-w-[1rem] text-center">
                        {pageNum()}
                      </span>
            ...
            <div class="flex flex-col gap-3 pb-6 border-b border-gray-100">
              ...
              >
                <div class="p-4 rounded-xl border border-dashed border-gray-200 bg-gray-50 flex flex-col items-center justify-center text-center">
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    class="h-6 w-6 text-gray-300 mb-2"
                    fill="none"
                    viewBox="0 0 24 24"
                    stroke="currentColor"
                  >
                  ...
                  <p class="text-[10px] text-gray-400 mt-1">
                    Anda hanya memiliki akses untuk melihat (preview) dokumen
                    ini.
                  </p>
                </div>
              </Show>
              ...
              >
                ...
                >
                  <div class="flex items-center gap-2 mb-2">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      class={`h-4 w-4 ${doc()?.approval_status === "APPROVED" ? "text-green-600" : "text-red-600"}`}
                      fill="none"
                      viewBox="0 0 24 24"
                      stroke="currentColor"
                    >
                    ...
                    <p class="text-[11px] uppercase tracking-wider font-bold text-gray-600">
                      Catatan Reviewer
                    </p>
                  </div>
                          ...
                          class={`absolute -left-[21px] top-2.5 w-2.5 h-2.5 rounded-full ring-4 ring-white z-10 shadow-sm transition-transform group-hover:scale-110 ${
                            {
                              ...
                              EDIT: "bg-orange-500",
                              DELETE: "bg-red-600",
                              ROLLBACK: "bg-indigo-500",
                              REQUEST_APPROVAL: "bg-amber-500",
                              APPROVE: "bg-emerald-500",
                              REJECT: "bg-rose-600",
                            }[log.action] || "bg-gray-400"
                          }`}
                        ></div>
              ...
              <div class="space-y-3">
                ...
                >
                  <For each={versions()}>
                    {(v) => (
                      <div
                        class={`p-3 rounded-lg border ${v.is_active ? "bg-blue-50 border-blue-200" : "bg-white border-gray-200"} flex justify-between items-center transition-all`}
                      >
                        <div>
                          <div class="flex items-center gap-2">
                            ...
                            <Show when={v.is_active}>
                              <span class="bg-blue-100 text-blue-700 text-[10px] px-2 py-0.5 rounded font-bold border border-blue-200">
                                AKTIF
                              </span>
                            </Show>
                            <Show
                            ...
                            >
                              <span class="bg-gray-100 text-gray-500 text-[10px] px-2 py-0.5 rounded font-bold border border-gray-200">
                                {v.approval_status}
                              </span>
                            </Show>
                          </div>
                        ...
                        >
                          <button
                            onClick={() =>
                              handleRollback(v.id_version, v.version_number)
                            }
