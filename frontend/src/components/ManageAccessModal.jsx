        ...
        <div class="flex-1 overflow-y-auto p-6 space-y-8">
          ...
          <div>
            ...
            <form
              ...
              class="bg-blue-50/50 border border-blue-100 p-4 rounded-xl space-y-4"
            >
              <div>
              ...
              <div>
                ...
                <div class="grid grid-cols-2 gap-3">
                  ...
                  <label class="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={permissions().preview}
                      onChange={() => handleTogglePermission("preview")}
                  ...
                  <label class="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={() => handleTogglePermission("download")}
                      class="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                    />
                  ...
                  <label class="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      onChange={() => handleTogglePermission("upload")}
                      class="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                    />
                  ...
                  <label class="flex items-center gap-2 cursor-pointer">
                    <input
                      type="checkbox"
                      checked={permissions().edit_metadata}
                      onChange={() => handleTogglePermission("edit_metadata")}
                      class="w-4 h-4 text-blue-600 rounded border-gray-300 focus:ring-blue-500"
                    />
          ...
          <div>
            ...
            <div class="border border-gray-200 rounded-xl overflow-hidden">
              ...
              >
                <Show
                  when={accessList().length > 0}
                  fallback={
                    <div class="p-8 text-center text-sm text-gray-500 italic">
                      Belum ada user yang diberi akses khusus.
                    </div>
                  }
                >
                        ...
                        <div class="p-4 flex items-center justify-between hover:bg-gray-50 transition">
                          ...
                          <div class="flex items-center gap-4">
                            ...
                            <div class="flex gap-1">
                              <span
                                class={`w-6 h-6 flex items-center justify-center rounded text-xs ${item.preview ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-300"}`}
                                title="Preview"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                                ...
                                >
                                  <path
                                    fill="currentColor"
                                    d="M3 21V3h18v18zm2-2h14V7H5zm3.338-3.113Q6.725 14.776 6 13q.725-1.775 2.338-2.887T12 9t3.663 1.113T18 13q-.725 1.775-2.337 2.888T12 17t-3.662-1.112m2.6-1.826Q10.5 13.626 10.5 13t.438-1.062T12 11.5t1.063.438T13.5 13t-.437 1.063T12 14.5t-1.062-.437m2.837.712Q14.5 14.05 14.5 13t-.725-1.775T12 10.5t-1.775.725T9.5 13t.725 1.775T12 15.5t1.775-.725"
                                  />
                                </svg>
                              </span>
                              <span
                                class={`w-6 h-6 flex items-center justify-center rounded text-xs ${item.download ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-300"}`}
                                title="Download"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                              ...
                              <span
                                class={`w-6 h-6 flex items-center justify-center rounded text-xs ${item.upload ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-300"}`}
                                title="Upload"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
                              ...
                              <span
                                class={`w-6 h-6 flex items-center justify-center rounded text-xs ${item.edit_metadata ? "bg-blue-100 text-blue-700" : "bg-gray-100 text-gray-300"}`}
                                title="Edit"
                              >
                                <svg
                                  xmlns="http://www.w3.org/2000/svg"
