  ...
  return (
    <div class="flex h-screen bg-[#F4F7FE]">
      ...
      <div class="w-64 bg-white shadow-sm flex flex-col z-10">
        <div class="p-6">
          <h2 class="text-xl font-bold text-blue-600 flex items-center gap-2">MedDocs</h2>
        </div>
        ...
        <nav class="flex-1 px-4 space-y-2 text-sm">
            ...
            <A href="/departments" class={`flex items-center gap-3 px-4 py-3 rounded-lg ${activeClass('/departments')}`}>
                Department
            </A>
