      ...
      <div class="w-[260px] bg-sidebar flex flex-col shrink-0">
        ...
        <div class="px-5 py-5 border-b border-sidebar-border">
          <div class="flex items-center gap-3">
            ...
            <div>
              <h2 class="text-base font-bold text-white tracking-tight">MedDocs</h2>
              <p class="text-[10px] text-sidebar-text tracking-wide">Document Management</p>
            </div>
          </div>
        </div>
        ...
        <nav class="flex-1 px-3 pt-4 space-y-1 overflow-y-auto">
          <Show when={currentUser()?.role != "admin"}>
            <A href="/draft" class={navLinkClass("/draft")}>
              <svg xmlns="http://www.w3.org/2000/svg" class="h-[18px] w-[18px] shrink-0 opacity-70" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="1.8">
        ...
        <div class="px-3 py-4 border-t border-sidebar-border">
          <div class="flex items-center gap-3 px-2">
            ...
            <div class="flex-1 min-w-0">
              <p class="text-xs font-semibold text-sidebar-text-active truncate">{currentUser()?.name}</p>
              <p class="text-[10px] text-sidebar-text capitalize">{currentUser()?.role}</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <header class="bg-white px-6 py-4 flex justify-between items-center border-b border-gray-100 shrink-0">
          ...
          <div class="flex items-center gap-3">
            <div class="text-right mr-1 hidden sm:block">
              ...
              <p class="text-[11px] text-gray-400 capitalize">{currentUser()?.role}</p>
            </div>
            <button
