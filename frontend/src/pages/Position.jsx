                    ...
                    data().map((item) => (
                        <tr class="border-b last:border-0 hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 text-right">
                                ...
                                <button onClick={() => handleDelete(item.id_position)} class="text-red-500 hover:text-red-700">Delete</button>
                            </td>
                        </tr>
                    ))
                )}
      ...
      {isModalOpen() && (
        <div class="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div class="bg-white rounded-xl shadow-lg w-96 p-6">
                <h3 class="text-lg font-bold mb-4">{editId() ? "Edit Position" : "Add New Position"}</h3>
                <form onSubmit={handleSubmit}>
                    <label class="block text-sm text-gray-600 mb-2">Position Name</label>
                    <input 
                        type="text" 
